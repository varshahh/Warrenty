      ...
      {filteredProducts.length === 0 ? (
        ...
        <div style={{
          ...
          {filteredProducts.map((p) => {
            ...
            const progress = totalDays > 0 ? (daysRemaining / totalDays) * 100 : 0;
            ...
            return (
              ...
              <div key={p.product_id} style={{
                ...
                <h3>
                  <Link to={`/product/${p.product_id}`} style={{ color: "#333" }}>
                    {p.product_name}
                  </Link>
                </h3>
                ...
                <div style={{ marginTop: "10px" }}>
                  <button onClick={() => setPreviewBill(billURL)} style={buttonStyle("#17a2b8")}>
                    View
                  </button>

                  <button onClick={() => forceDownload(billURL, "bill.png")} style={buttonStyle("#4facfe")}>
                    <FaDownload /> Bill
                  </button>

                  <button onClick={() => shareProduct(p)} style={buttonStyle("#28a745")}>
                    Share
                  </button>
                  ...
                  <button onClick={() => deleteProduct(p.product_id)} style={buttonStyle("#dc3545")}>
                    Delete
                  </button>
                </div>
